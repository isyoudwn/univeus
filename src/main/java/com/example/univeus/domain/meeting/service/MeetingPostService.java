...
public interface MeetingPostService {
    MeetingPost writePost(Long memberId, MeetingPostRequest.MeetingPostContent meetingPostContent,
                          MeetingPostRequest.MeetingPostImagesUris meetingPostImages);

    void deletePost(Long memberId, Long postId);

    MeetingPost findById(Long postId);

    MeetingPost findByIdWithLock(Long postId);
